...
class Urnas(Base):
  ...
  # codigoCarga = Column(String(24), nullable=False)
  # dataHoraCarga = Column(DateTime, nullable=False)
  # numeroInternoUrna = Column(Integer, nullable=False)
  # numeroSerieFC = Column(String(8), nullable=False)
